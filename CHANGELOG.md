...
- Fixed changelog and source code URIs in gemspec to remove incorrect `.git` extensions that broke links on the gem page
...
[unreleased]: https://github.com/HealthDataInsight/structured_store/compare/v1.1.1...HEAD
