  ...
  module RefResolvers
    ...
    class CustomLookupResolverTest < ActiveSupport::TestCase
      ...
      test 'define_attribute with integer attribute' do
        ...
        store_record = DefaultStoreRecord.new(store_versioned_schema: VersionedSchema.new(json_schema: schema))
      ...
      test 'define_attribute with untested attribute type' do
        ...
        exception = assert_raises(RuntimeError) do
          DefaultStoreRecord.new(store_versioned_schema: VersionedSchema.new(json_schema: schema))
        end
